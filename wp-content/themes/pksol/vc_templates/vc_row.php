...
}elseif($type_row == 'contact1'){
    $images = wp_get_attachment_image_src($ses_image,'');
    $output .='<section class="contact-1" data-bg-img="'.esc_url($images[0]).'">
  <div class="container">
...
}elseif($type_row == 'contact2'){
    $images = wp_get_attachment_image_src($ses_image,'');
    $output .='<section class="contact-1 pt-0" data-bg-img="'.esc_url($images[0]).'">
  <div class="container">
