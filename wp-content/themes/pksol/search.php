...
<?php } ?>
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-12">
        <h1 class="title"><?php printf( esc_html__( 'Search Results for: %s', 'loptus' ), get_search_query() ); ?></h1>
  ...
  <div class="container">
    <div class="row">
      ...
      <?php if ( have_posts() ) : 
        ...
        <?php endwhile; else :?> 
            <div class="search-custom side-bar" ><h5><?php
                            // If no content, include the "No posts found" template.
                            echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'loptus' ) ;?></h5>
