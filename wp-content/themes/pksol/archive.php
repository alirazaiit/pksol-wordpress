  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-12">
        <h1 class="title"><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives: %s', 'loptus' ), get_the_date() );

                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'loptus' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'loptus' ) ) );

                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'loptus' ), get_the_date( _x( 'Y', 'yearly archives date format', 'loptus' ) ) );

                        else :
                            echo esc_html__( 'Archives', 'loptus' );
